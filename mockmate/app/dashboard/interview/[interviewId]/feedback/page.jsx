  ...
  return (
    <div className='p-10'>
     ...
     {feedbackList&&feedbackList.map((item,index)=>(
      ...
      <CollapsibleTrigger className='p-2 bg-secondary rounded-lg my-2 text-left flex flexx-col gap-7 text-md w-full'>{item.Question}<ChevronsUpDown className='h-5 w-5 mx-2'/></CollapsibleTrigger>
      <CollapsibleContent>
       <div className='felx flex-col gap-2'>
        <h2 className='text-red-500 p-2 border rounded-lg text-md'><strong>Rating:</strong>{item.rating}</h2>
